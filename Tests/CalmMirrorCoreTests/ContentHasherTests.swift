...
final class ContentHasherTests: XCTestCase {
    ...
    func testDifferentBlockerTitleProducesDifferentHash() {
        let hashA = ContentHasher.computeContentHash(
            startDate: fixedStart, endDate: fixedEnd, isAllDay: false, blockerTitle: "[Acme] Old name"
        )
        let hashB = ContentHasher.computeContentHash(
            startDate: fixedStart, endDate: fixedEnd, isAllDay: false, blockerTitle: "[Acme] New name"
        )
    ...
    func testIdenticalBlockerTitleProducesSameHash() {
        let hashA = ContentHasher.computeContentHash(
            startDate: fixedStart, endDate: fixedEnd, isAllDay: false, blockerTitle: "[Acme] Busy"
        )
        let hashB = ContentHasher.computeContentHash(
            startDate: fixedStart, endDate: fixedEnd, isAllDay: false, blockerTitle: "[Acme] Busy"
        )
